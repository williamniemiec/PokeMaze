#include "../../../../include/wniemiec/io/consolex/OutputConsolex.hpp"
...
void OutputConsolex::write_line_with_enumeration(std::string line, int line_number) {
    ...
    printf(format.c_str(), std::to_string(line_number).c_str(), line.c_str());
...
std::list<std::string> OutputConsolex::get_history()
{
